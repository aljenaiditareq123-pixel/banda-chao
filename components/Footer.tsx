      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">Banda Chao</h3>
            <p className="text-sm mb-6 max-w-md leading-relaxed">
              {t('footerDescription') || 'منصة اجتماعية تجارية تربط الحرفيين المبدعين مع محبي المنتجات الأصيلة حول العالم'}
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-white transition p-2 hover:bg-gray-800 rounded-lg">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-semibold mb-4">{t('quickLinks') || 'روابط سريعة'}</h4>
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href={`/${language}/makers`} className="hover:text-white transition">
                  {t('makers') || 'الحرفيون'}
                </Link>
              </li>
              <li>
                <Link href={`/${language}/products`} className="hover:text-white transition">
                  {t('products') || 'المنتجات'}
                </Link>
              </li>
              <li>
                <Link href={`/${language}/videos`} className="hover:text-white transition">
                  {t('videos') || 'الفيديوهات'}
                </Link>
              </li>
              <li>
