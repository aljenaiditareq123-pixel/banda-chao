          ...
          <div className="p-4 border-t border-gray-200 bg-white rounded-b-lg">
            <div className="flex gap-2">
              <VoiceInput
                ...
                placeholder={language === 'ar' ? 'اكتب رسالتك أو اضغط الميكروفون للتحدث...' : 'Type your message or click microphone to speak...'}
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">
              {language === 'ar'
                ? 'جرب: "الشحن" أو "الدفع" أو "الإرجاع" أو استخدم الميكروفون 🎤'
                : 'Try: "shipping" or "payment" or "returns" or use microphone 🎤'}
            </p>
          </div>
        </div>
      )}
