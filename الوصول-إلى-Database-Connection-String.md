# 🔗 الوصول إلى Database Connection String

**الموقع الحالي:** Project Settings → General  
**الموقع المطلوب:** Database Settings → Connection string
...
2. اضغط على **"Database"** (مع أيقونة external link 🔗)
3. سيتم فتح صفحة Database Settings
...
## 🔍 **بديل: من القائمة الجانبية الرئيسية**

إذا كنت في الصفحة الرئيسية للمشروع:
