...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    'onboardingStep1Title': 'ما هو Banda Chao؟',
    'onboardingStep1Description': 'منصة اجتماعية تجارية تربط بين الحرفيين المبدعين والمشترين المهتمين بالمنتجات اليدوية والحرفية الفريدة.',
    'onboardingStep2Title': 'تصفح الحرفيين',
    'onboardingStep2Description': 'اكتشف حرفيين موهوبين من مختلف المجالات، شاهد قصصهم، منتجاتهم، وفيديوهاتهم الإبداعية.',
    'onboardingStep3Title': 'استكشف المنتجات',
    'onboardingStep3Description': 'تصفح مجموعة واسعة من المنتجات اليدوية الفريدة، من الأعمال الفنية إلى المنتجات الحرفية.',
    'onboardingStep4Title': 'شاهد الفيديوهات واتبع المبدعين',
    'onboardingStep4Description': 'استمتع بالفيديوهات القصيرة والطويلة، تابع الحرفيين المفضلين لديك، وكن جزءاً من المجتمع الإبداعي.',
    'skip': 'تخطي',
    ...
    'shortVideoDescription': 'حد أقصى 60 ثانية، لجذب الانتباه',
    'longVideoDescription': 'حد أقصى 10 دقائق، لتوثيق عملية التصنيع',
  ...
  en: {
    ...
    'onboardingStep1Description': 'A social commerce platform connecting creative makers with buyers interested in unique handmade and artisanal products.',
    'onboardingStep2Title': 'Browse Makers',
    'onboardingStep2Description': 'Discover talented makers from various fields, view their stories, products, and creative videos.',
    'onboardingStep3Title': 'Explore Products',
    'onboardingStep3Description': 'Browse a wide range of unique handmade products, from artworks to artisanal goods.',
    'onboardingStep4Title': 'Watch Videos & Follow Creators',
    'onboardingStep4Description': 'Enjoy short and long videos, follow your favorite makers, and be part of the creative community.',
    'skip': 'Skip',
