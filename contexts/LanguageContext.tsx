...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'shortVideoDescription': '最多60秒，用于吸引注意力',
    'longVideoDescription': '最多10分钟，用于记录制作过程',
    'makerDashboard': '制造商仪表板',
    'manageYourMakerProfile': '管理您的制造商档案和内容',
    'viewPublicProfile': '查看公开档案',
    'editProfile': '编辑档案',
    'editMakerProfile': '编辑制造商档案',
    'notRegisteredAsMaker': '您还没有注册为制造商',
    'becomeMakerDescription': '注册为制造商，在平台上展示您的产品和内容。与世界分享您的工艺故事，吸引新客户。',
    'becomeMaker': '成为制造商',
    ...
    'onboardingStep1Description': '一个连接创意制造商和对独特手工产品感兴趣的买家的社交商务平台。',
    'onboardingStep2Title': '浏览制造商',
    'onboardingStep2Description': '发现来自不同领域的有才华的制造商，查看他们的故事、产品和创意视频。',
    'onboardingStep3Title': '探索产品',
    'onboardingStep3Description': '浏览各种独特的手工产品，从艺术作品到手工艺品。',
    'onboardingStep4Title': '观看视频并关注创作者',
    'onboardingStep4Description': '享受短视频和长视频，关注您喜欢的制造商，成为创意社区的一部分。',
    'skip': '跳过',
    'getStarted': '开始',
    'close': '关闭',
    'makersPage': '制造商页面',
