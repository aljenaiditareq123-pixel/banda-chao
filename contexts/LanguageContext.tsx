...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'totalLikes': '总点赞数',
    'pillar1Title': '对手作人公平',
    'pillar1Body': '透明收费、公平定价工具和直连全球买家，让每一笔成交都物有所值。',
    'pillar2Title': '让买家更放心',
    'pillar2Body': '实名认证的手作人、清晰的物流信息和完善的买家保障机制，帮助跨境买卖建立真正的信任。',
    'pillar3Title': 'AI 熊猫助你成长',
    'pillar3Body': '内置的 AI 助手——我们的"熊猫"——为创始人、手作人和买家提供规划、翻译和业务指导，陪你一起成长。',
