...
export default function LongVideosPageClient() {
  ...
  const fetchVideos = async () => {
    try {
      ...
      const response = await videosAPI.getVideos('long', currentPage, ITEMS_PER_PAGE);
          ...
          <>
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center space-x-2 mt-8">
                {currentPage > 1 && (
                  <Link
                    href={`/videos/long?page=${currentPage - 1}`}
