...
export default function RegisterPage() {
  ...
  return (
    <div 
      className={`min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 ${isRTL ? 'rtl' : ''}`}
      dir={isRTL ? 'rtl' : 'ltr'}
    >
      <div className={`max-w-md w-full space-y-8 ${isRTL ? 'text-right' : 'text-left'}`}>
        <div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleRegister}>
          ...
          <div>
            ...
            >
              {loading ? t('registerButtonLoading') : success ? t('registerButtonSuccess') : t('registerButton')}
            </button>
          </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-50 text-gray-500">{t('registerOr')}</span>
              </div>
            </div>
